...
<div class="container my-5">
    ...
    <p class="text-center">
        Dengan sistem pembayaran yang aman dan pilihan metode pembayaran seperti <strong>COD</strong> (Bayar di Tempat), kartu kredit, dan transfer bank, 
        ZALORA memberikan kemudahan bagi setiap pelanggan. Selain itu, kami menawarkan <strong>pengembalian gratis selama 30 hari</strong> 
...
<div class="container">
    <h6 class="fw-bold mt-4">TIPS BELANJA DI TOKO BAJU ONLINE</h6>
    ...
    <h6 class="fw-bold mt-4">Tentukan model yang disukai</h6>
    <p class="text-justify">
    ...
    <h6 class="fw-bold mt-4">Cek isi lemari</h6>
    <p class="text-justify">
    ...
    <h6 class="fw-bold mt-4">Cek isi dompet</h6>
    <p class="text-justify">
...
<footer class="bg-dark text-white pt-5 pb-4">
    <div class="container text-md-left">
        <div class="row text-md-left">
            ...
            <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                ...
                <p>
                    Sebagai Pusat Fashion Online, kami menciptakan berbagai kemungkinan gaya tanpa batas 
                    dengan memperluas jangkauan produk dari produk internasional hingga produk lokal dambaan. 
                    <strong>Bersama Toko Hj.Mariam, You Own Now.</strong>
                </p>
            </div>
    ...
    <p>Bantuan</p>
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                <h5 class="text-uppercase mb-4 font-weight-bold text-warning">Anda Baru di Toko Hj.Mariam?</h5>
                <p>Dapatkan berita mode terbaru dan promo menarik dengan subscribe newsletter kami.</p>
                <form>
                    <input type="email" placeholder="someone@example.com" class="form-control mb-2">
                    <div class="d-flex">
                        <button class="btn btn-outline-light btn-sm mx-1">WANITA</button>
                        <button class="btn btn-outline-light btn-sm mx-1">PRIA</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-7 col-lg-8">
                <p>
                    © 2024 Toko Hj.Mariam. Semua Hak Dilindungi.
                </p>
            </div>
